...
const EN_PRESS: SourceSeed[] = [
  ...
  { name: 'TechRadar Computing', url: 'https://www.techradar.com/computing', roles: ['COVERAGE'],
    lang: 'en', trust: 0.2, weightContent: 0.1, neverCanonical: true, pollSeconds: 4 * H },
];
...
const BLOGS: SourceSeed[] = [
  ...
  { name: 'Netflix Tech Blog', url: 'https://netflixtechblog.com/', roles: ['CONTENT'],
  ...
  { name: 'OpenAI blog', url: 'https://openai.com/blog', roles: ['PRIMARY', 'CONTENT'],
  ...
  { name: 'Fly.io blog', url: 'https://fly.io/blog/', roles: ['CONTENT'], lang: 'en',
...
const JA: SourceSeed[] = [
  ...
  { name: 'ITmedia NEWS', url: 'https://www.itmedia.co.jp/news/', roles: ['CONTENT', 'COVERAGE'],
  ...
  { name: 'Qiita', url: 'https://qiita.com/', roles: ['CONTENT', 'DISCOVERY'], lang: 'ja',
...
// ---------------------------------------------------------------------------
const DE: SourceSeed[] = [
  { name: 'heise online', url: 'https://www.heise.de/', roles: ['CONTENT', 'COVERAGE'],
...
const EXPERIENCE: SourceSeed[] = [
  ...
  { name: 'Google Cloud status', url: 'https://status.cloud.google.com/', feedKind: 'api',
    roles: ['EXPERIENCE', 'PRIMARY'], lang: 'en', trust: 1.0, weightContent: 0.3,
    neverCanonical: true, pollSeconds: 15 * M },
  { name: 'LowEndTalk', url: 'https://lowendtalk.com/', roles: ['EXPERIENCE'], lang: 'en',
